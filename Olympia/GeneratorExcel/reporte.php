<?php
    ...
    //Se denomina a el archivo que sera descargado
    $hojaActiva -> setTitle("Datos");

    // En la hoja se ocupan las siguientes funciones para pintar sobre la hoja de datos 
    // Esta se acomodo decauerdo a los requerimientos de RH
    ...
    //Hacemos uso de una variable llamada fila que empezara desde 2, esto debido al formato de la hoja
    //Entonces hacemos uso del cilo while con los resultados de nuestras consultas Query para empezar el pintado
    //Podemos observar que la fila va en aumento hasta que se acaben los datos, por lo que se tendra que reiniciar la variable cada que se pinte
    ...
    //Una vez que se pintaron los datos se cierra el buffer con la siguiente funcion 
    ob_end_clean();
    //Ahora se utilizan cabecera para poder extraer el archivo Excel, se tomaan en cuenta varias variables como se observa

    header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    header('Content-Disposition: attachment;filename="datos.xlsx"');
    header('Cache-Control: max-age=0');
    //Utilizamos otra funcion de la libreria
